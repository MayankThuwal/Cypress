...
describe('Order discard flow', () => {
    ...
    describe('Verify order is discarded ', () => {
        it('Should display the order discarded notification alert', () => {
            orderPage.clickDiscardOrderButton();
            orderPage.clickDiscardPopupConfirmButton();
            orderPage.verifyOrderDiscardStepperValidationErrors().orderDiscardedSuccessfully();
        });
    });
